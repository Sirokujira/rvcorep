...
set_property -dict { PACKAGE_PIN J5   IOSTANDARD LVCMOS12} [get_ports { CLK }];
...
set_property -dict { PACKAGE_PIN F7    IOSTANDARD LVCMOS18 } [get_ports { w_rxd }];
set_property -dict { PACKAGE_PIN F8    IOSTANDARD LVCMOS18 } [get_ports { r_txd }];
###############################################################################################
